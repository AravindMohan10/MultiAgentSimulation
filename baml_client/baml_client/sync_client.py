...
class BamlSyncClient:
    ...
    def ChooseAgentAction(self, system_prompt: str,user_prompt: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ChooseAgentAction", args={
...
class BamlStreamClient:
    ...
    def ChooseAgentAction(self, system_prompt: str,user_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.AgentAction, types.AgentAction]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ChooseAgentAction", args={
            "system_prompt": system_prompt,"user_prompt": user_prompt,
        })
        return baml_py.BamlSyncStream[stream_types.AgentAction, types.AgentAction](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ChooseAgentAction(self, system_prompt: str,user_prompt: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ChooseAgentAction", args={
            "system_prompt": system_prompt,"user_prompt": user_prompt,
        }, mode="request")
        return __result__
